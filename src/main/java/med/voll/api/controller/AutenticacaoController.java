...
public class AutenticacaoController { //Autenticação do usuário
    ...
    @PostMapping
    public ResponseEntity efetuarLogin(@RequestBody @Valid DadosAutenticacao dados) { //a responsabilidade desse método é autenticar as credenciais do usuário e devolver um token como resposta
